        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
          <thead>
            <tr style={{ borderBottom: '2px solid #334155' }}>
              ...
              <th style={{ padding: '12px', textAlign: 'left', color: '#94a3b8', width: '100px' }}>Deal ID</th>
              <th style={{ padding: '12px', textAlign: 'left', color: '#94a3b8', width: '150px' }}>Shopify Order ID</th>
              <th style={{ padding: '12px', textAlign: 'left', color: '#94a3b8', width: '80px' }}>Category</th>
              <th style={{ padding: '12px', textAlign: 'left', color: '#94a3b8', width: '120px' }}>Stage</th>
              <th style={{ padding: '12px', textAlign: 'left', color: '#94a3b8', width: '100px' }}>Fulfillment</th>
              <th style={{ padding: '12px', textAlign: 'left', color: '#94a3b8', width: '180px' }}>Received At</th>
              {onPreviewEvent && (
